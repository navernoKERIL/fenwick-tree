...
% Простая нумерация в правом нижнем углу
...
\begin{itemize}
\item Любая структура для динамического RSQ должна тратить $\Omega(\log n)$ на операцию.
...
\begin{itemize}
\item \textbf{Algorithmica}: \url{https://algorithmica.org/ru/fenwick}
\item \textbf{НИУ ИТМО, Алгоритмы}: 
      \url{https://neerc.ifmo.ru/wiki/index.php?title=Дерево_Фенвика}
\item \textbf{CP-Algorithms}: \url{https://cp-algorithms.com/data_structures/fenwick.html}
\end{itemize}
\end{block}

\begin{block}{Исходный код и презентация}
\begin{itemize}
\item GitHub репозиторий: \url{https://github.com/navernokeril/fenwick-tree}
\item Исходники LaTeX, примеры кода и PDF презентации доступны в репозитории
\end{itemize}
\end{block}
